...
int main()
{
	...
	bitset<4> bset1sc(9);      // bset1 contains 1001
	bitset<4> bset2sc(3);      // bset2 contains 0011

							 // comparison operator
	cout << (bset1sc == bset2sc) << endl;  // false 0
	cout << (bset1sc != bset2sc) << endl;  // true  1

									   // bitwise operation and assignment
	cout << (bset1sc ^= bset2sc) << endl;  // 1010
	cout << (bset1sc &= bset2sc) << endl;  // 0010
	cout << (bset1sc |= bset2sc) << endl;  // 0011

									   // left and right shifting
	cout << (bset1sc <<= 2) << endl;     // 1100
	cout << (bset1sc >>= 1) << endl;     // 0110

									   // not operator
	cout << (~bset2sc) << endl;          // 1100

									   // bitwise operator
	cout << (bset1sc & bset2sc) << endl;    // 0010
	cout << (bset1sc | bset2sc) << endl;    // 0111
	cout << (bset1sc ^ bset2sc) << endl;    // 0101
