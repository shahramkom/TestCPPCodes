...
class ShPackageWindowPane :
	public CComObjectRootEx<CComSingleThreadModel>,
	public VsWindowPaneFromResource<ShPackageWindowPane, IDD_ShPackage_DLG>,
	public VsWindowFrameEventSink<ShPackageWindowPane>,
...
{
	VSL_DECLARE_NOT_COPYABLE(ShPackageWindowPane)

protected:

	// Protected constructor called by CComObject<ShPackageWindowPane>::CreateInstance.
	ShPackageWindowPane() :
...
BEGIN_COM_MAP(ShPackageWindowPane)
...
BEGIN_MSG_MAP(ShPackageWindowPane)
...
END_MSG_MAP()
	...
	{
		VsWindowFrameEventSink<ShPackageWindowPane>::SetSite(GetVsSiteCache());
...
class ShPackageToolWindow :
	public VSL::ToolWindowBase<ShPackageToolWindow>
{
public:
	...
	ShPackageToolWindow(const PackageVsSiteCache& rPackageVsSiteCache):
	...
	IUnknown* GetViewObject()
	{
		...
		CComObject<ShPackageWindowPane>* pViewObject;
		VSL_CHECKHRESULT(CComObject<ShPackageWindowPane>::CreateInstance(&pViewObject));
