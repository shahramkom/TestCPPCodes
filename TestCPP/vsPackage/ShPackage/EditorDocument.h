...
[$RootKey$\KeyBindingTables\{d83e5eec-245f-4fce-b5be-f64ced6d3568}]
@="#1"
...
ShPackageUI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_ShPackageLib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_ShPackageCmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_ShPackageEditorDocument, LastMacro, eLastMacroNone> m_Recorder;
