...
/***************************************************************************
ShPackage.pkgdef contains:


[$RootKey$\Editors\{609a3f46-d327-40fc-aba9-00453fb80695}]
@="ShPackage"
"Package"="{99b32a0f-4993-4e51-bece-fb41a31e181a}"
"DisplayName"="ShPackage"
"ExcludeDefTextEditor"=dword:00000001
"AcceptBinaryFiles"=dword:00000000

[$RootKey$\Editors\{609a3f46-d327-40fc-aba9-00453fb80695}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{609a3f46-d327-40fc-aba9-00453fb80695}\Extensions]
"shpackage"=dword:00000032

which informs the shell that ShPackagePackage is the package to create to have this editor 
registered with Visual Studio.  When ShPackagePackage is sited by Visual Studio, 
ShPackagePackage::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
		...
		VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
	{
		if(physicalViewId == Primary)
		{
			...
			rpguidCommandUI = &CLSID_ShPackageEditorDocument;
