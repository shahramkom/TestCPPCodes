...
#define FILTER_FRIENDLY_NAME        L"ShNdisFilterDriver NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{8c23585d-5b83-4dcf-8294-f910f440d840}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"ShNdisFilterDriver"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\ShNdisFilterDriver"
#define NTDEVICE_STRING             L"\\Device\\ShNdisFilterDriver"
...
DRIVER_DISPATCH ShNdisFilterDriverDispatch;

DRIVER_DISPATCH ShNdisFilterDriverDeviceIoControl;
